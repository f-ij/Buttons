...
private:
    ...
    int inputType; // Which input type to use. (e.g. INPUT, INPUT_PULLUP)

public:
    Button(int pin, unsigned long jitterDelay = 15, int activeState = LOW, unsigned long pressWindow = 200, unsigned long holdWindow = 300, int maxPresses = 3, int inputType);
